var insertForm158046208 = function () {
  var html158046208 =
    "<style text='text/css'>" +
    ...
    '<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Women\'s Hope Medical Clinic</span></label>' +
    "</div>" +
    ...
    "      <label id='noCaptchaResponseError' class='error noCaptchaResponseError' style='display: none'>You must fill out the CAPTCHA</label><div id=\"captcha158046208\"></div>" +
    "" +
    "</div>" +
    '    <div class="btn-group">' +
  ...
  (function ($) {
    ...
    if (jQuery("#bloomerangForm158046208").length) {
      ...
      jQuery("#bloomerangForm158046208").after(html158046208);

      Bloomerang.Util.requireStripe(function () {
        Bloomerang.Util.Stripe = Stripe("pk_live_iZYXFefCkt380zu63aqUIo7y");

        Bloomerang.useKey("pub_9b3ebb83-4461-11ea-8134-0ab2f2f28c00");
    ...
    Bloomerang.Util.load(
      ...
      function () {
        ...
        jQuery("form.donation-form").data(
          "captcha-id",
          grecaptcha.render("captcha158046208", {
            sitekey: "6LffJ-UpAAAAAPtWK8VFwTVDuH3WIbHuMJPyFaAi",
          })
        );
      },
      true,
    ...
    Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (
      ...
      formContainer.show();
      formContainer.html(successHtml158046208);
    ...
    Bloomerang.Util.calculateDonationTrueImpact = function () {
      ...
      if (isPayPalVenmo) {
        ...
        impactAmount = Number(
          (Math.floor((newTotal - amount) * 100) / 100).toFixed(2)
        );
      } else {
    ...
    if (
      jQuery("#donation-form #DebitCard").length === 0 ||
    ...
    jQuery("#donation-form .section.payment input[type='radio']").click(
      function () {
        ...
        if (
          jQuery(this).attr("id") == "DebitCard" ||
          jQuery(this).attr("id") == "CreditCard"
        ) {
          jQuery(
...
var startBloomerangLoad = function () {
  if (window.bloomerangLoadStarted == undefined) {
    ...
    script.src =
      "https://crm.bloomerang.co/Content/Scripts/Api/Bloomerang-v2.js?nocache=1712081942";
